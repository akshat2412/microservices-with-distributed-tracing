...
export class Tracer {
  ...
  public createControllerSpan(controller: string, operation: string, parentObj?: any, format?: string) {
    let span: Span;
    let parentSpanContext: any = parentObj;
    if (parentObj) {
      if(format) {
